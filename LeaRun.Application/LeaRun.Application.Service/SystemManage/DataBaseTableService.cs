    ...
    public class DataBaseTableService : RepositoryFactory, IDataBaseTableService
    {
        ...
        public DataTable GetTableList(string dataBaseLinkId, string tableName)
        {
            ...
            if (dataBaseLinkEntity != null)
            {
                ...
                {
                    case "SqlServer":
                        strSql = GetSqlServerTableListSql(tableName);
                        break;
                    case "MySql":
                        strSql = GetMySqlTableListSql(tableName);
                        break;
                    case "Oracle":
                        strSql = GetOracleTableListSql(tableName);
                        break;
                }
                return this.BaseRepository(dataBaseLinkEntity.DbConnection, dataBaseLinkEntity.DbType).FindTable(strSql.ToString());
            }
            return null;
        }

        private StringBuilder GetMySqlTableListSql(string tableName)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(@"
                            SELECT t1.*,
        ...
        private StringBuilder GetOracleTableListSql(string tableName)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(@"
        ...
        private StringBuilder GetSqlServerTableListSql(string tableName)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public IEnumerable<DataBaseTableFieldEntity> GetTableFiledList(string dataBaseLinkId, string tableName)
        {
            ...
            if (dataBaseLinkEntity != null)
            {
                ...
                {
                    case "SqlServer":
                        return GetSqlServerTableFiledList(dataBaseLinkEntity, tableName);
                        break;
                    case "MySql":
                         GetMySqlTableFiledList(dataBaseLinkEntity, tableName);
                        break;
                    case "Oracle":
                        return GetOracleTableFiledList(dataBaseLinkEntity, tableName);
                        break;
                }
            }
            return null;
        ...
        private IEnumerable<DataBaseTableFieldEntity> GetOracleTableFiledList(DataBaseLinkEntity dataBaseLinkEntity, string tableName)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return this.BaseRepository(dataBaseLinkEntity.DbConnection, dataBaseLinkEntity.DbType).FindList<DataBaseTableFieldEntity>(strSql.ToString(), parameter);

        }

        private void GetMySqlTableFiledList(DataBaseLinkEntity dataBaseLinkEntity, string tableName)
        {
            throw new NotImplementedException();
        }

        private IEnumerable<DataBaseTableFieldEntity> GetSqlServerTableFiledList(DataBaseLinkEntity dataBaseLinkEntity, string tableName)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public DataTable GetTableDataList(string dataBaseLinkId, string tableName, string switchWhere, string logic, string keyword, Pagination pagination)
        {
            ...
            if (dataBaseLinkEntity != null)
            {
                ...
                return this.BaseRepository(dataBaseLinkEntity.DbConnection, dataBaseLinkEntity.DbType).FindTable(strSql.ToString(), parameter.ToArray(), pagination);
            }
            return null;
        }
        #endregion
        ...
        public void SaveForm(string dataBaseLinkId, string tableName, string tableDescription, IEnumerable<DataBaseTableFieldEntity> fieldList)
        {
            ...
            this.BaseRepository(dataBaseLinkEntity.DbConnection, dataBaseLinkEntity.DbType).ExecuteBySql(strSql.ToString());
